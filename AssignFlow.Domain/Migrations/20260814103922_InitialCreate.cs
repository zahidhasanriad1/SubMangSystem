    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CourseEnrollments", x => new { x.CourseOfferingId, x.StudentId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CourseTeachers", x => new { x.CourseOfferingId, x.TeacherId });
                    table.ForeignKey(
                        name: "FK_CourseTeachers_CourseOfferings_CourseOfferingId",
                        column: x => x.CourseOfferingId,
                        principalTable: "CourseOfferings",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Assignments_CourseOfferingId_Status_DeadlineUtc",
                table: "Assignments",
                columns: new[] { "CourseOfferingId", "Status", "DeadlineUtc" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClassRooms_Name_Section_AcademicYear",
                table: "ClassRooms",
                columns: new[] { "Name", "Section", "AcademicYear" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CourseOfferings_ClassRoomId_SubjectId",
